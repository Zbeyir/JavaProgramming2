    ...
    public static void main(String[] args) {
        ...
        for (Employee scrumMember : scrumMembers) {
            if (scrumMember instanceof Tester) {
                testers.add((Tester) scrumMember); // burada casting yaptik dikkat ==> testers.add(scrumMember); __ normalde böyle idi yani
            }
            if (scrumMember instanceof  Developer){
                developers.add((Developer) scrumMember); // casting yaptik bura da da
            }
        }
