...
public class BuildInFunctionalInterfaces2 {
    ...
    public static void main(String[] args) {
        ...
        boolean r1 = contains.test(arr, 12);
        ...
        boolean r2 = anagram.test(str1, str2);
         ...
         */
// lambada expiration yukarida uzun uzun ugrastigimizi daha kisa yoldan ve daha kolay yapiyor
        ...
        BiFunction<int[], int[], List<Integer>> merge = (x, y) -> {
            ...
            for (int each : x) result.add(each);  // lambada expiration 'nun icinde cörliy brasses yazabiliriz
