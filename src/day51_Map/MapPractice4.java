 ...
 */
        ...
        System.out.println("========================================================");
        System.out.println("sadece bir grub un tüm elemanlarini istiyorsak");
        for (String each : groups.get(9)) {
            System.out.println(each);
        }

        System.out.println("========================================================");
        System.out.println("sadece bir grub un belirli bir elemani ni istiyorsak, 2. get te index num yaziyoruz zaten maus hower üzerinde tutunca cikiyor");
        System.out.println(groups.get(2).get(2));
